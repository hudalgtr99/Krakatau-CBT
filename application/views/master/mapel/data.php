        ...
        <div class="container-fluid">
                            ...
                            <div class="table-responsive">
                                <table id="tableSubKelompok" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th class="text-center align-middle">Kode</th>
                                        <th class="align-middle">Nama</th>
                                        <th class="text-center align-middle">Jenis Utama</th>
                                        <th class="text-center align-middle p-0"><span>Aksi</span></th>
                                    </tr>
                                    </thead>
                                </table>
            ...
            <div class="card my-shadow mb-4">
                <div class="card-header with-border">
                    <h3 class="card-title text-bold">Daftar Mata Ujian</h3>
                ...
                <div class="card-body">
                    <div class="alert alert-default-light border border-success align-content-center mb-3" role="alert">
                        <b>Nomor Urut Mata Ujian</b> dan <b>Jenis</b> diperlukan jika ingin mencetak hasil
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="tableMapel" class="w-100 table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="text-center align-middle p-0 w-auto">No.Urut Mata Ujian</th>
                                <th class="text-center">Mata Ujian</th>
                                <th class="text-center">Kode Mata Ujian</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editKelompokModalLabel">Jenis Mata Ujian</h5>
...
<div class="modal fade" id="editSubKelompokModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSubKelompokModalLabel">Sub Jenis Mata Ujian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">Jenis Utama*</label>
                    <div class="col-md-9">
...
<div class="modal fade" id="createMapelModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Tambah Mata Ujian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">Mata Ujian*</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row" id="formkode">
                    <label class="col-md-2 col-form-label">No. Urut Mata Ujian*</label>
                    <div class="col-md-10">
...
<div class="modal fade" id="editMapelModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Mata Ujian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="editDataMapelModal" tabindex="-1" role="dialog" aria-labelledby="editDataMapelModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDataMapelModalLabel">Setting Mata Ujian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
