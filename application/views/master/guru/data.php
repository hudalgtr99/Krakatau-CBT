        ...
        <div class="container-fluid">
            <div class="card card-default my-shadow mb-4">
                <div class="card-header">
                    <h6 class="card-title">Data Pengawas</h6>
                    <div class="card-tools">
                        ...
                        <a href="<?= base_url('dataguru/import') ?>" class="btn btn-sm bg-gradient-primary"><i
                                    class="fas fa-upload"></i><span class="d-none d-sm-inline-block ml-1">Tambah Pengawas</span></a>
                    </div>
                </div>
                <div class="card-body">
                    <?php
                        ...
                        <table id="list-guru" class="table w-100 dataTable no-footer" role="grid"
                            ...
                            <tr role="row">
                                <th class="align-middle p-0 sorting_asc" tabindex="0" aria-controls="listguru"
                                    ...
                                    style="width: 0;" aria-sort="ascending">Profil Pengawas
                                </th>
                            </tr>
                            </thead>
                            <tbody class="row">
